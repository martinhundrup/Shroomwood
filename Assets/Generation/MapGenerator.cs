...
public class MapGenerator : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (numberOfRooms > mapSize * mapSize) return; // Ensure numberOfTiles is valid
        InitRoomTiles();
    ...
    private void InitRoomTiles()
    {
        ...
        while (placedTileCount < numberOfRooms) // Change to < to ensure we place the correct number of tiles
        {
            PlaceRandomTile();
            placedTileCount++;
        }
